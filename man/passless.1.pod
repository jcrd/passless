...
The configuration file F<~/.passless.conf.gpg> is an INI file where section
names are sites and section keys correspond to B<lesspass> command-line
arguments.
...
Copyright 2019 James Reed. passless is licensed under the MIT License.
